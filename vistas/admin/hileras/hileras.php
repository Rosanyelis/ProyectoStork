                                ...
                                <tbody>
                                    <?php foreach ($data as $item) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $item->largo_hilera ?></td>
                                            <td><?php echo $item->ancho_hilera ?></td>
                                            <td><?php echo $item->largo_hilera * $item->ancho_hilera ?></td>
                                            <td><?php echo $item->hectareas ?></td>
                                            <td><?php echo intval($item->plantas_teoricas) ?></td>
                                            <td>
                                                <div class="dropdown">
