...
<?php include '../../../controladores/Hileras/EditHilerasController.php'; ?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Editar Hilera</h4>
                        </div>
                        <div class="card-body">
                            <form class="form" action="../../../controladores/Hileras/UpdateHilerasController.php?id=<?php echo $_REQUEST['id']; ?>&idcc=<?php echo $_REQUEST['idcc']; ?>&idhilera=<?php echo $data->id_hilera ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="metro_hilera">Metros de la Hilera</label>
                                            <input type="text" id="metro_hilera" class="form-control" value="<?php echo $data->metro_hilera ?>" name="metro_hilera">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="arbol_hilera">Arboles en la Hilera</label>
                                            <input type="text" id="arbol_hilera" class="form-control" value="<?php echo $data->arbol_hilera ?>" name="arbol_hilera">
                                        </div>
                                    </div>
