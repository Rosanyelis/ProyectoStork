...
$cantidadAreaTotal = $_POST['cantidadAreaTotal'];
...
$sql1 = "INSERT INTO Presupuesto (fechaInicio, fechaTermino, fechaIngreso, campo, centroCosto, labor, cantidadAreaTotal, lugarAplicacion,
 cantidadHileraTotal, cantidadArbolesTotal, CantidadMetrosHileraTotal, cantidadPersona, precioPersona, valorFinalHerramienta,
 valorFinalProducto, valorFinalPersonal, valorFinal, estatus, porcentaje_completado)
 VALUES 
 ('$fechaInicio', '$fechaTermino', '$fechaActual', '$campo', '$centroCosto', '$labor', '$cantidadAreaTotal', '$lugarAplicacion', 
 '$cantidadHileraTotal', '$cantidadArbolesTotal', '$CantidadMetrosHileraTotal', '$cantidadPersona', '$precioPersona',
 '$valorFinalHerramienta', '$valorFinalProducto', '$valorFinalPersonal', '$valorFinal', 'Por Confirmar', '0')";
