...
<?php include '../../../controladores/Maquinaria/EditmaquinariaAdminController.php'; ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="editarMaquinaria" class="row" action="../../../controladores/Maquinaria/AgregarMaquinariaAdminController.php?id=<?php echo $id; ?>" method="POST">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="maquinaria" name="maquinaria">
                                            ...
                                            <?php foreach ($data['maquinaria'] as $item) { ?>
                                                <option value="<?php echo $item->c_maquinaria;?> - <?php echo $item->n_maquinaria;?>"><?php echo $item->c_maquinaria;?> - <?php echo $item->n_maquinaria;?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <table class=" table loteProductos">
                                            ...
                                            <?php 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-danger" href="../../../controladores/Maquinaria/EliminarMaquinariaAdminController.php?id=<?php echo $item->id_herrEje;?>&idP=<?php echo $id; ?>">Eliminar</a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
