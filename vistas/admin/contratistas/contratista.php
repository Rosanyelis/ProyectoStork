    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Contratistas</h2>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h4 class="card-title">Listado de Contratistas</h4>
                            <div class="text-right">
                                <a href="createcontratista.php" class="btn btn-primary" type="button"><span><i data-feather='plus'></i>Nuevo Contratista</span></a>
                            </div>
                        </div>
