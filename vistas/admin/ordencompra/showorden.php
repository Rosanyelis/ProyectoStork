...
<?php include '../../../controladores/OrdenCompra/ShowordencompraController.php'; ?>
    ...
    <div class="content-header row">
        ...
        <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
            <div class=" breadcrumb-right">
                <a href="ordendecompra.php" class="btn btn-dark" ><span><i data-feather='arrow-left'></i>Regresar</span></a>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Factura #<?php echo $data['data']->numerorden; ?> </h4>
                        </div>
