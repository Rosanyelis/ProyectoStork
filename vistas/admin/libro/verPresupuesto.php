...
$consultaProductoEjecucion = sqlsrv_query($conn,("SELECT * FROM ProductoPresupuesto  WHERE id_presupuesto = '$id'" ));
$consultaMaquinariaEjecucion = sqlsrv_query($conn,("SELECT * FROM HerramientaPresupuesto WHERE id_presupuesto = '$id'" ));
