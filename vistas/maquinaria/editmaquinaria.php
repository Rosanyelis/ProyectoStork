                                        ...
                                        <table class=" table loteProductos">
                                            ...
                                            <?php 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-danger" name="<?php echo $item->id_herrEje;?>"
                                                            id="<?php echo $item->id_herrEje;?>"
                                                            href="eliminar_herramienta.php?ID=<?php echo $item->id_herrEje;?>&ID2=<?php echo $id; ?>"
