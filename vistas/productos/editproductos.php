            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="editarMaquinaria" class="row" action="" method="POST">
                                <div class="col-md-3">
                                        ...
                                        <table class=" table loteProductos">
                                            ...
                                            <?php 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-danger" name="<?php echo $item->id_prodEje;?>"
                                                            id="<?php echo $item->id_prodEje;?>"
                                                            href="eliminar_herramienta.php?ID=<?php echo $item->id_prodEje;?>&ID2=<?php echo $id; ?>"
                                ...
                                <div class="col-md-12 text-right">
                                    ...
                                    <button type="button" id="" class="btn float-right btn btn-primary ">Finalizar Edición</button>
                                </div>
                            </form>
                        </div>
                    </div>
