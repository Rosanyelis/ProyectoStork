                                ...
                                <table class="dt-responsive table">
                                    ...
                                    <tbody>
                                        <?php foreach ($data as $item) { ?>
                                            <tr>
                                                <td><?php echo $item->n_producto ?></td>
                                                <td><?php echo $item->cod_producto ?></td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" style="">
                                                            <a class="dropdown-item" href="showbodega.php?id=<?php echo $item->n_producto ?>">
                                                            <i data-feather="eye"></i>
                                                                <span>Ver</span>
                                                            </a>
                                                            <a class="dropdown-item" href="editbodega.php?id=<?php echo $item->n_producto ?>">
                                                                <i data-feather="edit-2"></i>
                                                                <span>Editar</span>
                                                            </a>
                                                            <a class="dropdown-item" href="../../controladores/Bodega/DeletebodegaController.php?id=<?php echo $item->n_producto ?>">
