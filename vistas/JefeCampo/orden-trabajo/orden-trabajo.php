...
<?php include '../../../controladores/OrdenTrabajo/ListarordentrabajoJefeCampoController.php'; ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($item->estatus == 'Aprobada' || $item->estatus == 'En Ejecucion') { ?>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="../orden-trabajo/capturarordentrabajo.php?id=<?php echo $item->id_presupuesto ?>">
