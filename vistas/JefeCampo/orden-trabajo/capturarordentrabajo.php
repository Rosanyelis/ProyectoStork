            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="capturaOrden" class="row" action="../../../controladores/OrdenTrabajo/AgregarOrdenTrabajoJefeCampoController.php?id=<?php echo $id?>" method="POST">
                                ...
                                <div class="col-md-4" id="divHorario">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="horario_parcial" placeholder="Ej: 8:00 AM a 12:00 PM">
                                    </div>
                                </div>  
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12 col-12">
                                    <!-- <section class="card-datatable"> -->
                                        <table class=" table lotePersonalMaquinaria">
                                            <thead>
                                                <tr>
                                                    <th>Rut Personal</th>
                                                    <th>Tipo Jornada</th>
...
$(window).on('load', function() {
    ...
    $('#tipoPersonal').change(function() {
        ...
        if (personal == 'contratista') {
            $("#Personal").empty().append("<option>Seleccione ...</option><option>Trato 1</option><option>Trato 2</option><option>Trato 3</option>");
        }
    });
    ...
    $('#aggPersonal').on('click', function() {
        ...
        if (!horario) { horario  = '8:00am a 6:00pm'; }
        if (!Maquinaria) { Maquinaria  = $('#MaquinariaInput').val(); }
        if (!Implemento) { Implemento  = $('#ImplementoInput').val(); }
        
        let fila = "<tr><td>" + Personal + "</td><td>" + tipo_jornada + "</td><td>" + horario + "</td><td>" + Maquinaria + "</td><td>" + Implemento + "</td><td>" + mojamientom +
