...
<?php include '../../../controladores/productos/EditproductoController.php'; ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="editarProducto" class="row" action="../../../controladores/Productos/AgregarproductoController.php?id=<?php echo $id; ?>" method="POST">
                                <div class="col-md-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-danger" 
                                                            href="../../../controladores/Productos/EliminarProductoController.php?id=<?php echo $item->id_prodPres;?>&idP=<?php echo $id; ?>">
                                                            Eliminar</a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
    ...
    $('#producto').change(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#unidad_producto').val(response.data.unidadItem);
                $('#unidad_producto_precio').val(response.data.valor);
                $('#valor_producto').val('');
