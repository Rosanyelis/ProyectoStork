...
<?php include '../../controladores/Campos/EditcampoController.php'; ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" action="../../controladores/Campos/UpdatecampoController.php?id=<?php echo $data->id_Campo ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="nombre-campo">Nombre de Campo</label>
                                            <input type="text" id="nombre-campo" class="form-control" value="<?php echo $data->nombre ?>" name="nombre">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="area-total">Área Total</label>
                                            <input type="text" id="area-total" class="form-control" value="<?php echo $data->area_total ?>" name="area_total">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="cantidad_cc">Cantidad de Centro de Costos</label>
                                            <input type="text" id="cantidad_cc" class="form-control" value="<?php echo $data->cantidad_cc ?>" name="cantidad_cc">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="promedio_cc">Promedio de Centro de Costos</label>
                                            <input type="text" id="promedio_cc" class="form-control" name="promedio_cc" value="<?php echo $data->promedio_cc ?>">
                                        </div>
                                    </div>
